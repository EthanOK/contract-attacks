...
| 2026.06.17 | [Little Boy Plus](./attack-event/LittleBoyPlus.md) | BSC | ~377k USDT | `0x55856d9fda4c5be5193561c7d775e823c3d6e499da44aab9da963daf61c50b0c` | `contracts/test/LittleBoyPlus/LittleBoyPlusChallenge.t.sol` | `LBPHashrate._update(0)` 仍 `_harvest` + `mintReward` 致 Pair balance≠reserves |
